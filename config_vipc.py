...
__C.DATASETS.SHAPENET.VIPC_PATH        = '/media/kshitij/KSHIT/ShapeNetViPC-Dataset'#path to dataset
#
# Constants
#
__C.CONST                                        = edict()
...
#
__C.DIR                                          = edict()
__C.DIR.OUT_PATH                                 = '/home/kshitij/kshitij/EGIInet/project_logs'#path to save checkpoints and logs
...
__C.CONST.WEIGHTS = r"/home/kshitij/kshitij/EGIInet/checkpoints/all-eight-ckpt-best.pth" #path to pre-trained checkpoints
