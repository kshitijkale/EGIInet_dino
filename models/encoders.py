...
#         # DINOv2 forward_features returns a dictionary with 'x_norm_patchtokens' key
#         if isinstance(features, dict):
#             # Get patch tokens (without CLS token)
#             patch_embeddings = features['x_norm_patchtokens']
#         else:
#             # If it returns a tensor, remove CLS token (first token)
#             patch_embeddings = features[:, 1:, :]
#         print(f"H is {H//self.patch_size[0]} and W is {W//self.patch_size[1]}")
#         return patch_embeddings, H//self.patch_size[0], W//self.patch_size[1]
